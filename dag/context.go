...
// ID is the id of the DAG execution the task belongs to. uuid.Nil outside a
// task.
func ID(ctx context.Context) uuid.UUID { return taskFromContext(ctx).DAGID }
