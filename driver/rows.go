...
const (
	...
	// SourceDAG tags DAG tasks created through the DAGStore
	// capability; they share the unified job table and settlement machinery.
	SourceDAG Source = "dag"
	// SourceWorkflow tags workflow-as-code tasks (workflow advances and
	// Operations) created through the WorkflowStore capability.
...
const (
	...
	// satisfied yet; PromoteUnblocked releases it (SourceDAG only).
	...
	// failure policy or an operator verb (SourceDAG only).
	StateCancelled JobState = "cancelled"
	// StateUncertain marks a workflow-as-code Operation whose outcome could
