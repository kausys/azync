...
`Open` / `New` never migrate. Prefer one shared Core per process ([`examples/shared-core`](examples/shared-core)); use `queue.Open` / `event.Open` / … when a runtime should own a private Core.

## Guides and examples

| Guide | Example |
|-------|---------|
| [queue.md](queue.md) | [`examples/queue-basic`](examples/queue-basic) |
| [event.md](event.md) | [`examples/event-basic`](examples/event-basic) |
| [dag.md](dag.md) | [`examples/dag-basic`](examples/dag-basic) |
| [workflow.md](workflow.md) | [`examples/workflow-kyc`](examples/workflow-kyc) |
